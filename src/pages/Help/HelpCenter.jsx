					...
					<Grid container justifyContent="center" spacing={3}>
						<Grid item >
							<Card className={classes.card} >
								...
								component={NavLink} to="/helpcenter/profileandaccount"
						...
						<Grid item >
							<Card className={classes.card} >
								<CardHeader
								style={{textDecoration: 'none'}}
								component={NavLink} to="/helpcenter/billingandsubscription"
									className={classes.cardHeader}
						...
						<Grid item >
							<Card className={classes.card}>
								<CardHeader
								style={{textDecoration: 'none'}}
								 component={NavLink} to="/helpcenter/safetyandprivacy"
									className={classes.cardHeader}
						...
						<Grid item >
							<Card className={classes.card} >
								<CardHeader style={{textDecoration: 'none'}} component={NavLink} to="/helpcenter/features" className={classes.cardHeader} title=" Features" />
								<CardContent className={classes.cardContent}>
									<p>
						...
						<Grid item >
							<Card className={classes.card}>
								<CardHeader
								 component={NavLink}  to="/helpcenter/livefaq"
									className={classes.cardHeader}
									title=" Live FAQ’s"
									style={{textDecoration: 'none'}}
								/>
